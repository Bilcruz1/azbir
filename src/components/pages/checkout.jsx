...
const Checkout = () => {
	...
	return (
		<div className="max-w-[1440px] mx-auto lg:px-[120px] px-[16px] ">
			...
			<div className="flex lg:mt-[48px] mt-[34px] justify-between">
				<h1 className="lg:text-[40px] text-[24px] text-[#253041] font-medium ">
					Checkout
				</h1>
				<div className="">
					<button
				...
				<div>
					...
					<div className="mb-4">
						...
						<input
							...
							className="w-full border rounded text-[12px] px-3 py-4 focus:outline-none focus:ring"
						/>
					</div>
					...
					<div className="mb-4 ">
						<select className="border px-3  py-3 text-[12px] text-[#7A7A7A] rounded w-full">
					...
					<input
						type="text"
						placeholder="Address"
						className="border px-3 py-3 text-[12px] rounded w-full mb-4"
					/>
					<input
						type="text"
						...
						className="border px-3 py-3 text-[12px] rounded w-full mb-4"
					/>
					<div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6 text-[12px]">
						<input
							type="text"
							placeholder="City"
							className="border px-3 py-3 rounded w-full"
						/>
						<select className="border px-3 py-3 text-[#7A7A7A] rounded w-full">
							<option>State</option>
							<option>Lagos</option>
							<option>Abuja</option>
						</select>
					...
					{/* Shipping Method */}
					<h2 className="text-[14px]  text-[#383838] font-medium mb-2">
						Shipping method
					</h2>
					<select className="border px-3 py-3 text-[#7A7A7A] rounded w-full mb-6">
					...
					<button
						className="bg-[#C89D1A] text-[#FFFFFF] w-full py-3 rounded-full text-[16px] font-semibold hover:bg-[#C89D1A]/90 transition"
						...
						>
							<div className="lg:flex gap-4">
								<img
									src={item.image}
									alt={item.name}
									className="  lg:min-w-[143px] lg:h-[91px] min-w-[340px] h-[170px]  rounded-3xl object-cover object-top"
								/>
								<div className="pt-3">
